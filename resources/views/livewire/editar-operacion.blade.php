                ...
                <div class="row">
                    <div class="mb-3 col-md-3" >
                        <div wire:ignore>
                            ...
                            <span class="h4">{{$operar->servicio->titulo}}</span>
                        </div>
                    </div>
                    <div class="mb-3 col-md-4">
                        <label for="fecha" class="form-label">Fecha:</label>
                        <span class="h4">{{date("d-m-Y",strtotime($operar->fecha))}}</span>
                    </div>
                    <div class="mb-3 col-md-4">
                        ...
                        <div class="form-group mt-5 justify-content-end col-md-2">
                            <div class="checkbox">
                                <div class="custom-checkbox custom-control">
                                    ...
                                    <label for="todosHotel" class="custom-control-label mt-1">Todos</label>
                                </div>
                            </div>
                        </div>
                    </div>
...
$('#proveedorIngreso').val('{{$proveedorIngreso ?? null}}').select2();
$('#proveedorIngreso').on('change',function(){
    @this.set('proveedorIngreso',this.value);
});

$('#servicioIngreso').val('{{$servicioIngreso ?? null}}').select2();
