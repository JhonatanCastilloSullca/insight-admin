        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content modal-content-demo">
                        ...
                        <div class="carousel slide" data-bs-ride="carousel" id="carouselExample2">
                            <div class="carousel-inner">
                                <div class="carousel-item border-none active">
                                    <img alt="img" class="d-block w-100" src="http://localhost:81/storage/paquetes/paquete2023.jpg">
                                </div>
                    ...
                    <div class="container px-5">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-md-6 p-4">
                                ...
                                <div class="row about-motto pt-0">
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="text-justify">
                                            <div class="text-dark tx-26 font-weight-semibold">Incluye:</div>
                                            <p class="tx-14 mb-4">
                                            ...
                                            <div class="border d-flex p-2 br-5 mb-2">
                                                <div class="recent-contacts me-3">
                                                    <div class="avatar rounded-circle">
                                                        <img alt="avatar" class="rounded-circle" style="height:inherit;" src="{{ $reserva['servicioData']['servicio']['img_principal'] }}">
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <div class="text-justify">
                                            <div class="text-dark tx-26 font-weight-semibold">No Incluye:</div>
                                            <p class="tx-14 mb-4">
                                                @foreach($reservaData as $reserva)
                                                @if(isset($reserva['servicioData']['servicio']))
                                            <div class="border d-flex p-2 br-5 mb-2">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 p-4">
                                    @if($imagenprincipal)
                                    @if(is_string($imagenprincipal))
                                    <p><img src="{{ asset('storage/'.$imagenprincipal) }}" class="br-5" alt="image"></p>
                                    @else
                                ...
                                <div class="col-lg-6 col-md-6 p-4">
                                    @if($imagensecundario)
                                    @if(is_string($imagensecundario))
                                    <p><img src="{{ asset('storage/'.$imagensecundario) }}" class="br-5" alt="image"></p>
                                    @else
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn ripple btn-primary" type="button" wire:click="updatePaquete({{ $paqueteIdupdate }})">Save changes</button>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    @if($imagenprincipal)
                                                    @if(is_string($imagenprincipal))
                                                    <img src="{{ asset('storage/'.$imagenprincipal) }}" class="imagen-principal">
                                                    @else
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    @if($imagensecundario)
                                                    @if(is_string($imagensecundario))
                                                    <img src="{{ asset('storage/'.$imagensecundario) }}" class="imagen-secundario">
                                                    @else
                                    ...
                                    <div class="card-body">
                                        ...
                                        <table class="table table-bordered table-hover mb-0 text-nowrap">
                                            <tbody>
                                                ...
                                                <tr class="tr-modal-detalle">
                                                    <td>
                                                        <input type="text" class="text-modal-detalle" value="{{ $service['titulo'] }}" wire:model="noincluyeservice.{{ $i }}.titulo">
                                                    </td>
                                                    <td class="" style="text-align: -webkit-center;">
    ...
    $('#descripcion').summernote({
        callbacks: {
            onInit: function(contents, $editable) {
                $('#descripcion').summernote('code', @json($descripcion));
            }
        }
    });
</script>
