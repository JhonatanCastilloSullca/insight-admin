<div class="main-container container-fluid">
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">Reprogramacion Reserva</span>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-12">
            <label for="comentariosRepro" class="form-label">Comentario Reprogramacion</label>
            <textarea class="form-control" name="comentariosRepro" id="comentariosRepro" rows="2" wire:model.defer="comentariosRepro"></textarea>
        </div>
    </div>
    <div class="row">
            ...
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class=" col-md-6">
                            <label for="fecha_viajehotel" class="form-label">Fecha Inicio:</label>
                            <input type="datetime-local" name="fecha_viajehotel" id="fecha_viajehotel" class="form-control" wire:model.defer="fecha_viajehotel" >
                        ...
                        <div class=" col-md-6">
                            ...
                            <input type="datetime-local" name="fecha_viajehotelfin" id="fecha_viajehotelfin" class="form-control" wire:model.defer="fecha_viajehotelfin" >
