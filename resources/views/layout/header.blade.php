...
<div class="main-header side-header sticky nav nav-item">
	<div class=" main-container container-fluid">
		...
		<div class="main-header-right">
			...
			@php $tipoCambio = \App\Models\TipoCambio::latest('fecha')->first(); @endphp
			Compra: {{$tipoCambio->precioCompra}} &nbsp;&nbsp;&nbsp; Venta: {{$tipoCambio->precioVenta}}
			<div class="mb-0 navbar navbar-expand-lg navbar-nav-right responsive-navbar navbar-dark p-0">
				<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
					<ul class="nav nav-item header-icons navbar-nav-right ms-auto">
						{{-- @livewire('vista-notificaciones') --}}
						...
						<li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
							<a class="new nav-link profile-user d-flex" href="" data-bs-toggle="dropdown"><img alt="" src="{{asset(''.Auth::user()->imagen)}}" class=""></a>
							<div class="dropdown-menu">
								<div class="menu-header-content p-3 border-bottom">
									<div class="d-flex wd-100p">
										<div class="main-img-user"><img alt="" src="{{asset(''.Auth::user()->imagen)}}" class=""></div>
