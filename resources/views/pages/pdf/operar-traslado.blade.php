...
<head>
    ...
    <title>Operacion Traslado</title>
    <style>
...
<div class="container-fluid">
    <div class="card">
        <div class="row">
            <h1 style="TEXT-ALIGN: CENTER; line-height: 70px; color:#1b4474; padding-bottom: 20px;"> Traslados {{date("d/m/Y", strtotime($operacion->fecha))}} </h1>
            <div class="card-body">
                <div class="table-responsive" >
                    <table  class="table table-sm">
                        <tbody>
                            <tr>
                                <td class="id_pasajero" style="border-top:0px; font-size:0.7rem; color:#375a64;"><b>Fecha: </b>{{date("d/m/Y", strtotime($operacion->fecha))}}</td>
                                <td class="id_pasajero"style="border-top:0px; font-size:0.7rem; color:#375a64;"><b  >Usuario: </b>{{$operacion->user->nombre}}</td>
                            </tr>
                            <tr>
                    ...
                    <table id="detalles" class="table table-bordered table-striped table-sm">
                        <thead>
                            <tr style="background-color:#2ba5b0; color:#ffffff; font-size: 0.9rem;">
                                ...
                                <th colspan="9" class="text-center"><label class="text-center"> {{$proveedor['nombre_proveedor']}}</label></th>
                            </tr>
