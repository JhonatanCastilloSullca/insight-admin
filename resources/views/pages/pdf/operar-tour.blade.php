...
<div class="container-fluid">
    <div class="card">
        <div class="row">
            <h1 style="TEXT-ALIGN: CENTER; line-height: 70px; color:#375a64; padding-bottom: 20px;"> Tour Operado: {{$operar->servicio->titulo}} / {{ date('d/m/Y', strtotime($operar->fecha)) }}</h1>
            <div class="card-body">
                <div class="table-responsive" >
                    <table  class="table table-sm">
                        <tbody>
                            ...
                            <tr>
                                @foreach($operar->operarServicios as $ope)
                                    <td style="border-top:0px; font-size:0.65rem;color:#375a64;"><b >{{$ope->servicio->titulo}}: </b>{{$ope->proveedor->nombre}}</td>
                                @endforeach
                            </tr>
                    ...
                    <table id="detalles" class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{date("h:i a",strtotime($detalle->recojo))}}
                                </td>
                                <td>
                                    {{$detalle->observacion}}
                                </td>
