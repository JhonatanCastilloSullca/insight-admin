...
<strong style="font-size: 14px;">Fecha de Viaje:</strong> <span style="font-size: 14px;">Fecha por confirmar</span>  
<strong style="font-size: 14px;">Número de Participantes:</strong> <span style="font-size: 14px;">{{$reserva->primerafecha()->pax}}</span>  
