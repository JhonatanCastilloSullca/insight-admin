...
<div class="main-container container-fluid">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">Listado de operaciones Hotel segun fecha a Realizarse</span>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('operacion.createhotel') }}" method="GET">
                        <div class="row pb-4">
                            <div class="col-md-3">
