    ...
    <div class="main-container container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h2 class="text-primary mb-3">Tour Operado: {{ $operar->servicio->titulo }} / {{ date('d/m/Y', strtotime($operar->fecha)) }}</h2>
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-3">
                                <div class="card-header bg-transparent pb-0">
                                    <div>
                                        <h3 class="card-title mb-2">Estado:</h3>
                                    </div>
                                </div>
                            ...
                            @foreach($operar->operarServicios as $ope )
                                <div class="mb-3 col-md-3">
                                    <div class="card-header bg-transparent pb-0">
                                        <div>
                                            <h3 class="card-title mb-2">Operador {{$ope->servicio->titulo }}:</h3>
                                        </div>
                                    </div>
                                    <div class="text-muted tx-12 text-center mb-2">
                                        {{ $ope->proveedor->nombre }} ({{ $ope->moneda_id == 2 ? '$' : 'S/' }} {{ $ope->precio }})
                                    </div>
                                </div>
                            @endforeach
                        </div>
