...
<div class="main-container container-fluid">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">Listado de Operaciones</span>
        </div>
        <div class="justify-content-center mt-2">

            <a href="{{ route('operacion.createtours')}}">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('operacion.tours') }}" method="GET">
                        <div class="row pb-4">
                            <div class="col-md-3">
                            ...
                            <tbody>
                                @foreach($operaciones as $operacion)
                                    <tr >
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('operacion.whatsappoperaciontour', ['operacion_id' => $operacion->id]) }}" target="_blank">
                                                    <button type="button" class="btn btn-success btn-icon me-2">
                                                        <i class="fab fa-whatsapp"></i>
                                                    </button>
                                                </a>

                                                <a href="{{ route('operacion.editaroperaciontours', ['operar' => $operacion->id]) }}">
                                                    <button type="button" class="btn btn-dark btn-icon me-2">
                                                        <i class="fa fa-edit"></i>
                                                    </button>
                                                </a>

                                                <a href="{{ route('operacion.operarshowtour',$operacion) }}" class="btn btn-info btn-icon me-2">
                                                    <i class="fa fa-eye"></i>
                                                </a>
    
                                                <a href="{{ route('operacion.pdf',$operacion) }}" target="_blank" class="btn btn-warning btn-icon me-2">
                                                    <i class="fa fa-file"></i>
                                                </a>

                                                <a href="{{ route('operacion.pdfrestaurant',$operacion) }}" target="_blank" class="btn btn-danger btn-icon">
