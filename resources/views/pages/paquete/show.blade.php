...
@push('head')
    ...
    <script
        ...
        kr-post-url-success="{{route('agradecimiento')}}">
    </script>
...
<div class="price-paq">
    <div class="card sales-card bg-transparent shadow-none">
        <div class="row">
            <div class="col-12">
                <div class="p-2">
                    <div class="pb-0 mt-0">
                        <div class="d-flex flex-column">
                            @if($moneda == 2)
                                <div class="rounded card d-flex flex-row p-0 m-0 pt-4 align-items-center bg-transparent">
                                    <div class="content-price px-2 bg-white rounded">
                                        <span class="text-dark font-weight-semibold fs-6" style="position: absolute; top: 20px; right: 65px; text-decoration: line-through;">$ {{$paquete->regulardolares}}</span>
                                        <h3 class="text-dark font-weight-semibold fs-1 mt-2">$ {{$paquete->precio_dolares}}</h3>
                                        <div class="form-group">
                                            <span class=" text-dark font-weight-semibold">Monto a Pagar S/ {{$monto}}</span>
                                            {{-- <input class="form-control" placeholder="" type="text"> --}}
                                        </div>
                                    </div>
                                    {{-- <div class="button-price p-2">
                                        <button type="button" class="btn btn-dark button-icon"><i class="fas fa-dollar-sign"></i></button>
                                    </div> --}}
                                </div>
                            ...
                            <div class="rounded card d-flex flex-row p-0 m-0 pt-4 align-items-center bg-transparent">
                                <div class="content-price px-2 bg-white rounded">
                                    <span class="text-dark font-weight-semibold fs-6" style="position: absolute; top: 20px; right: 65px; text-decoration: line-through;">S/ {{$paquete->regularsoles}}</span>
                                    <h3 class="text-dark font-weight-semibold fs-1 mt-2">S/ {{$paquete->precio_soles}}</h3>
                                    <div class="form-group">
                                        <span class=" text-dark font-weight-semibold">Monto a Pagar ${{$monto}}</span>
                                        {{-- <input class="form-control" placeholder="" type="text"> --}}
                                    </div>
                                </div>
                                {{-- <div class="button-price p-2">
                                    <button type="button" class="btn btn-dark button-icon"><b>S/</b></button>
                                </div> --}}
                            </div>
                            @endif
                            <div class="border-top"></div>
                            {{-- <div class="rounded card d-flex flex-row p-0 m-0 align-items-center justify-content-center">
                                <div class="form-group">
                                    <span class=" text-dark font-weight-semibold">Cupon de descuento</span>
                                    <div class="d-flex">
                                        <input class="form-control" placeholder="" type="text">
                                        <button type="button" class="btn btn-primary button-icon rounded-circle mx-2"><i class="far fa-check-circle"></i></button>
                                    </div>
                                </div>
                ...
                <div class="mg-sm-r-20 mg-b-10">
                    <div class="main-profile-contact-list">
                        <div class="media">
                            ...
                            <div class="media-body"> <span>Fecha de Inicio</span>
                                <div> {{ $paquete?->fecha_inicio }} </div>
                            </div>
                        </div>
                    </div>
                </div>
