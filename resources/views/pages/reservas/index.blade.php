    ...
    <div class="main-container container-fluid">
        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <span class="main-content-title mg-b-0 mg-b-lg-1">Listado de Reserva</span>
            </div>
                                            ...
                                            <td>
                                                <div class="dropdown" style="position: relative;">
                                                    ...
                                                    <ul class="dropdown-menu" style="position: absolute; top: 100%; left: 0; z-index: 1060;">
                                                        ...
                                                        <li><a class="dropdown-item" href="{{ route('reserva.devolucion', ['reserva' => $reserva, 'tipo' => 1]) }}" >Reprogramacion</a></li>
                                                        <button type="button" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#EliminarReserva" data-id="{{$reserva->id}}">
                                                            Eliminar
                                                        </button>
                                                        {{-- <li><a class="dropdown-item" href="{{ route('reserva.devolucion', ['reserva' => $reserva, 'tipo' => 2]) }}" >Cancelacion</a></li> --}}
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
