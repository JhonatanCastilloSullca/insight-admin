                                ...
                                <tbody>
                                    @foreach ($servicios as $servicio)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="mobil-break">{{ $servicio->proveedor?->nombre }}
                                                </div>
                                            </td>
                                            <td>
                                                <div class="mobil-break">{{ $servicio->proveedor?->categoria?->nombre }}
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <img style="width:125px;" src="{{ asset('' . $servicio->img_principal) }}"
                                                    alt="Imagen Servicio">
                                            </td>
                                            <td>
                                            ...
                                            @endcan --}}
                                                    ...
                                                    @can('servicio.destroy')
                                                        <li><a class="dropdown-item" data-bs-toggle="modal"
                                                                data-bs-target="#EliminarServicio"
                                                                data-id="{{ $servicio->id }}">Eliminar</a></li>
                                                    @endcan
                                                </ul>
                                            </td>
                                        </tr>
