...
<div class="main-container container-fluid">
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">Listado de Otros Servicios</span>
        </div>
        <div class="justify-content-center mt-2">
            @can('servicio.create')
            <a href="{{ route('servicio.create',4)}}">
                        ...
                        <table id="servicios" class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="mobil-break">{{ $servicio->operar ? 'Si' : 'No' }}
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <li><a class="dropdown-item" href="{{ route('servicio.show',$servicio->id) }}">Ver información</a></li>
                                            ...
                                            @can('servicio.destroy')
                                                <li><a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#cambiarServicio" data-id="{{$servicio->id}}">Cambiar Estado</a></li>
                                            @endcan
                                            @can('servicio.destroy')
            ...
            <div class="modal-body">
                <form action="{{route('servicio.destroy','test')}}" method="POST" autocomplete="off">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" name="otros" id="otros" value="1">
...
<!-- /Container -->
<div class="modal fade" id="cambiarServicio" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="{{route('servicio.destroy','test')}}" method="POST" autocomplete="off">
                    ...
                    <p>¿Estás seguro de cambiar el estado?</p>
                    <div class="modal-footer">
                        <input type="hidden" name="id_cambiar_2" id="id_cambiar_2">
                        <input type="hidden" name="otros" id="otros" value="1">
                        <button type="button" data-bs-toggle="tooltip" data-bs-title="Cancelar" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" data-bs-toggle="tooltip" data-bs-title="Aceptar" class="btn btn-primary">Aceptar</button>
                    </div>
...
<script>
    ...
    var cambiarServicio = document.getElementById('cambiarServicio');
    cambiarServicio.addEventListener('show.bs.modal', function(event) {
        var button = event.relatedTarget
        var id = button.getAttribute('data-id')
        var idModal = eliminarServicio.querySelector('#id_cambiar_2');
        idModal.value = id;
    })
