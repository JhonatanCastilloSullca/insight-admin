            ...
            <table id="usuarios" class="table table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <div class="mobil-break">{{$user->nombre}} {{$user->apellido}}</div>
                  </td>
                  <td>
                    <div class="mobil-break">{{$user->usuario}}</div>
                  </td>
                  <td>
                    <div class="mobil-break">{{$user->roles[0]->name}}</div>
                  </td>
                  <td>
                    <div class="mobil-break">{{$user->documento->tipo_documento}}</div>
                  </td>
                  <td>
                    <div class="mobil-break">{{$user->documento->num_documento}}</div>
                  </td>
                  <td>
                    <div class="mobil-break">{{$user->estado ? 'Activo':'Inactivo'}}</div>
                  </td>
                  <td>
