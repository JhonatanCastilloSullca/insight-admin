						...
						<div class="col-xl-5 col-lg-6 col-md-8 col-sm-8 col-xs-10 card-sigin-main mx-auto my-auto py-4 justify-content-center">
							<div class="card-sigin">
                                ...
                                <div class="main-card-signin d-md-flex justify-content-center">
                                    <div class="wd-100p"><div class="d-flex mb-4 justify-content-center"><a href="#"><img src="{{asset('img/brand/favicon-black.png')}}" class="sign-favicon ht-40" alt="logo"></a></div>
                                        <div class="">
												...
												<div class="panel panel-primary">
                                                    <form method="post" action="{{route('login')}}">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Usuario</label>
                                                            <input type="text" class="form-control" id="userEmail" placeholder="Usuario" name="usuario" value="{{old('usuario')}}">
                                                            @error('usuario')
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" class="form-control" id="userPassword" autocomplete="current-password" placeholder="Password"  name="password" value="{{old('password')}}">
                                                            @error('password')
                                                                <span class="error-message" style="color:red">{{ $message }}</span>
                                                            @enderror
                                                        </div>
