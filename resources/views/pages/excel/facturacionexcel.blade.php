            ...
            <table  class="table table-bordered table-striped table-sm">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="w-25">{{$searchDocumento}} </td>
                        <td class="w-25">Nº:</td>
                    ...
                    @foreach ($ventas as $i => $venta)
                        <tr>
                            ...
                            <td>{{$venta->document?->codSunat}}</td>
                            <td>{{$venta->document?->serie}}-{{$venta->nume_doc}}</td>
                            <td>{{date("Y-m-d",strtotime($venta->fecha))}}</td>
                            <td>{{date("Y-m-d",strtotime($venta->fecha))}}</td>
                            <td>{{$venta->venta?->document?->serie}}-{{$venta->venta?->nume_doc}}</td>
                            <td></td>
                            <td></td>
                            <td></td>
                            <td>Cusco</td>
                            ...
                            <td>{{ $venta->sunat == 1 ? 'Aceptado' : ($venta->sunat == 2 ? 'Anulado' : 'Anulado') }}</td>
                            <td>PEN</td>
                            <td>CONTADO</td>
                            <td>EFECTIVO</td>
                            <td>1</td>
