...
class LiquidacionController extends Controller
{
        ...
        try
        {
            ...
            if($request->tipo==1)
            {
                $liquidacion=Liquidacion::create([
                    ...
                    'saldo' => $request->precio - $request->acuenta,
                ...
                foreach($request->detalle as $i => $detalle1){
                    ...
                    $detalle=OperarServicio::find($request->detalle[$i]);
                    $detalle->estado=1;
                    $detalle->save();
                }
            }
    ...
    {
        return view('pages.liquidacion.pagar',compact('liquidacion'));
    }
}
