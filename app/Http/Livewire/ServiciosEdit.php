...
class ServiciosEdit extends Component
{
    use WithFileUploads;
    public $servicio_ant;
    public $titulo;
    ...
    public function mount($servicio = null)
    {
        ...
        if($this->categoriaint== 3){
            $this->hoteles = Proveedor::whereRelation('categoria','id',$this->categoriaint)->where('detalle_hotel',0)->get();
        }else{
            $this->hoteles = Proveedor::whereRelation('categoria','categoria_id',$this->categoriaint)->where('detalle_hotel',0)->get();
        }
        ...
        $this->plantillaOverview         = $this->servicio_ant->plantillaOverview;
        ...
        foreach($this->servicio_ant->precios as $i => $precio){
            ...
            $this->privadoTarifa[$i] = $precio->pivot->privado;
            $this->nacionalidadTarifa[$i] = $precio->pivot->nacional;
            $this->paxTarifa[$i] = $precio->pivot->pax;
