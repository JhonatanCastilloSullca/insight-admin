...
class AgregarIngresos extends Component
{
    ...
    public function mount($reservaId)
    {
        ...
        $detalles = DetalleReserva::select('detalle_reservas.id','detalle_reservas.comentarios','detalle_reservas.fecha_viaje','sr.titulo')
        ...
        ->join('servicios as sr', 'sr.id', '=', 'detalle_reservas.servicio_id')
