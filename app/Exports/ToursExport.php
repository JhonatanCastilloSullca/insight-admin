...
class ToursExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings
{
    use Exportable;

    public function __construct(public $reservas,public $fechaFin2,public $fechaInicio2,public $tour)
    {
    }
    ...
    public function view(): View
    {
        ...
        $tour = $this->tour;
        return view('pages.excel.tours', compact('fechaFin2','fechaInicio2','tour','reservas'));
    }
}
