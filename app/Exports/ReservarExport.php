...
class ReservarExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings
{
    use Exportable;

    public function __construct(public $reservas,public $fechaFin2,public $fechaInicio2,public $counter,public $pasajero,public $estado)
    {
    }
    ...
    public function view(): View
    {
        ...
        $estado = $this->estado;
        return view('pages.excel.reservas', compact('fechaFin2','fechaInicio2','counter','pasajero','estado','reservas'));
    }
}
