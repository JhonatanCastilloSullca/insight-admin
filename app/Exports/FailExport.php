...
class FailExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings
{
    use Exportable;

    public function __construct(public $files,public $fechaFin2,public $fechaInicio2)
    {
    }
    ...
    public function view(): View
    {
        ...
        return view('pages.excel.files', compact('fechaFin2','fechaInicio2','files'));
    }
}
