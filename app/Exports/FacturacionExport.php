...
class FacturacionExport implements FromView, ShouldAutoSize, WithStyles, WithDrawings
{
    ...
    public function __construct(public $ventas,public $fechaFin2, public $fechaInicio2,public $nume_documento2, public $searchCliente2,public $searchDocumento2, public $searchDocumento)
    {
    }
    ...
    public function view(): View
    {
        ...
        $searchDocumento = $this->searchDocumento;
        $searchCliente2 = $this->searchCliente2;
        $searchDocumento2 = $this->searchDocumento2;
        return view('pages.excel.facturacionexcel', compact('ventas','fechaFin2','fechaInicio2','nume_documento2','searchDocumento','searchCliente2','searchDocumento2'));
    }
}
